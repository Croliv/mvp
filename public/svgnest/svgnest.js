	...
	function SvgNest() {
		...
		this.launchWorkers = function (tree, binPolygon, config, progressCallback, displayCallback) {
			...
			p.map(function (pair) {
				...
				p2.require('/svgnest/clipper.js')
				p2.require('/svgnest/matrix.js')
				p2.require('/svgnest/geometryutil.js')
				p2.require('/svgnest/placementworker.js')
